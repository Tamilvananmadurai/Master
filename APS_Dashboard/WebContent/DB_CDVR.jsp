...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>EDIP</span> Dashboard</h2>
          <table cellspacing='0'> <!-- cellspacing='0' is important, must stay -->
	<tr><th>Application</th><th>Status</th></tr><!-- Table Header -->
    
<tr><td>JMS QUEUE</td><td><button class="button button2" >Red</button></td></tr><!-- Table Row -->
	<tr class='even'><td>DATA SOURCE</td><td><button class="button button1" >Green</button></td></tr><!-- Darker Table Row -->

	<tr><td>CPU</td><td><button class="button button1" >Green</button></td></tr>
	<tr class='even'><td>SERVER STATUS</td><td><button class="button button1" >Green</button></td></tr>
	
    <tr><td>DISK SPACE</td><td><button class="button button3" >Amber</button></td></tr>
	<tr class='even'></tr>

	<tr><td>LOGS MONITORING</td><td><button class="button button1" >Green</button></td></tr>
</table>
