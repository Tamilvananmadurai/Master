...
<tr><td>TPP</td><td><a href="EDIPsupport.jsp"><button class="button button2" >Red</button></a></td></tr><!-- Table Row -->
	<tr class='even'><td>NPS</td><td><button class="button button1" >Green</button></td></tr><!-- Darker Table Row -->

	<tr><td>CDV Rearch</td><td><button class="button button1" >Green</button></td></tr>
	<tr class='even'><td>NAE</td><td><button class="button button1" >Green</button></td></tr>
	
    <tr><td>P-CHART</td><td><button class="button button3" >Amber</button></td></tr>
	<tr class='even'></tr>

	<tr><td>DART</td><td><button class="button button1" >Green</button></td></tr>
</table>
