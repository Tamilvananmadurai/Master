...
<%@ page import="com.comcast.get.devops.dashboard.bean.*" %>
<%@ page import="com.comcast.get.devops.dashboard.control.*" %>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>WFA</span> Dashboard</h2>
          <table cellspacing='0'> <!-- cellspacing='0' is important, must stay -->
          
          
	<tr><th>Application</th><th>Status</th></tr><!-- Table Header -->
<%
ArrayList<DashboardStatus> DB_sts=new ArrayList<DashboardStatus>();
DB_sts=(ArrayList<DashboardStatus>)request.getAttribute("DB_sts1");
for(int i=0;i<DB_sts.size();i++)
	{if(DB_sts.get(i).getStatus()==1){%>    
<tr><td><%=DB_sts.get(i).getParameter() %></td><td><button class="button button1" >Green</button></td></tr><!-- Table Row -->
<%} else if(DB_sts.get(i).getStatus()==2) {%>
<tr><td><%=DB_sts.get(i).getParameter() %></td><td><button class="button button3" >Amber</button></td></tr><!-- Table Row -->
<%} else{%>
<tr><td><%=DB_sts.get(i).getParameter() %></td><td><button class="button button2" >Red</button></td></tr><!-- Table Row -->
<%} }%>
</table>
