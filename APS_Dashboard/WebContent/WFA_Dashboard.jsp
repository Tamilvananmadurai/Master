      ...
      <div class="mainbar">
        <div class="article">
          <h2><span>Support to</span> Company Name</h2>
           <%int WFA_sts=(int)request.getAttribute("WFA_sts1");%>
          <table cellspacing='0'> <!-- cellspacing='0' is important, must stay -->
	<tr><th>Application</th><th>Status</th></tr><!-- Table Header -->

<%if(WFA_sts==1){ %>    
<tr><td>WFA</td><td><a href="<%=request.getContextPath() %>/LoginControl?choice=11" name="App_Name" value="WFA"><button class="button button1" >GREEN</button></a></td></tr><!-- Table Row -->
<%}else if(WFA_sts==2){  %>
<tr><td>WFA</td><td><a href="<%=request.getContextPath() %>/LoginControl?choice=11&APP_Name=WFA" name="App_Name" value="WFA"><button class="button button3" >AMBER</button></a></td></tr><!-- Table Row -->
<%}else{ %>
<tr><td>WFA</td><td><a href="<%=request.getContextPath() %>/LoginControl?choice=11" name="App_Name" value="WFA"><button class="button button2" >RED</button></a></td></tr><!-- Table Row -->
<%}%>
</table>
